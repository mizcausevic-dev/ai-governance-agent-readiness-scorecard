...
import type { AiGovernanceReadinessExport, PostureOptions } from "./types.js";
...
const HELP = `ai-governance-agent-readiness-scorecard - analyze executive AI governance readiness exports

Usage:
  ai-governance-agent-readiness-scorecard <export.json> [--format json|markdown|summary]
...
const payload = JSON.parse(readFileSync(input, "utf8")) as AiGovernanceReadinessExport;
